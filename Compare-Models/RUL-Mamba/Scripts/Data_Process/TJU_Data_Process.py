...
def BatteryDataRead(args):
    root = 'Data/TJU_Data/Dataset_3_NCM_NCA_Battery/'
...
if __name__ == '__main__':
    ...
    np.save('Data/TJU_Data/Dataset_3_NCM_NCA_Battery_1C.npy', BatteryData_array, allow_pickle=True)
    
    BatteryData = np.load('Data/TJU_Data/Dataset_3_NCM_NCA_Battery_1C.npy', allow_pickle=True)
