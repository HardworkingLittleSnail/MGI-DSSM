...
from Models.Layers.FFT_Compat import compat_rfft
...
class TimesNet(nn.Module):
    ...
    def __init__(self, seq_len=24, label_len=0, pred_len=1, enc_in=7, c_out=1, e_layers=2, d_model=16, d_ff=32, top_k=5, embed='timeF', freq='h', dropout=0.1, num_kernels=6):
...
class TimesNetModel(BaseModel):
    def __init__(self, seq_len=24, label_len=0, pred_len=1, enc_in=7, c_out=1, e_layers=2,
                 d_model=16, d_ff=32, top_k=5, embed='timeF', freq='h', dropout=0.1, num_kernels=6, **kwargs):
        self.save_hyperparameters()
        super().__init__(**kwargs)
        self.network = TimesNet(
            seq_len=seq_len, label_len=label_len, pred_len=pred_len, enc_in=enc_in, c_out=c_out, e_layers=e_layers,
            d_model=d_model, d_ff=d_ff, top_k=top_k, embed=embed, freq=freq, dropout=dropout, num_kernels=num_kernels
        )
