...
BASE_CONFIG="${PROJECT_ROOT}/Configs/TJU/Univariable/Base.yaml"
TEST_NAME="CY25_1"
...
for MODEL in "${SELECTED_MODELS[@]}"; do
  MODEL_CONFIG="${PROJECT_ROOT}/Configs/TJU/Univariable/${MODEL}.yaml"
  echo "===== Training ${MODEL} ====="
  "${PYTHON_BIN}" "${PROJECT_ROOT}/Scripts/TJU_Univariable_RUL_Prediction/Train_TJU_Univariable.py" \
    --config "${BASE_CONFIG}" \
    --model "${MODEL}" \
