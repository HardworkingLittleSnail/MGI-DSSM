...
except ImportError:  # Optional: the standard iTransformer uses FullAttention.
...
class ReformerLayer(nn.Module):
    def __init__(self, attention, d_model, n_heads, d_keys=None,
        ...
        if LSHSelfAttention is None:
            raise ImportError("ReformerLayer requires the optional reformer_pytorch package")
