...
class TimeMixer(nn.Module):
    ...
    def __init__(self, task_name='short_term_forecast', seq_len=96, label_len=0, pred_len=96, enc_in=7, c_out=1,
                 e_layers=2, d_model=16, d_ff=32, top_k=5, embed='timeF', freq='h', dropout=0.1,
                 moving_avg=25, channel_independence=1, decomp_method='moving_avg', use_norm=1,
                 down_sampling_layers=3, down_sampling_window=2, down_sampling_method='avg', **kwargs):
...
class TimeMixerNetModel(BaseModel):
    def __init__(self, task_name='short_term_forecast', seq_len=24, label_len=0, pred_len=1, enc_in=7, c_out=1,
                 e_layers=2, d_model=16, d_ff=32, top_k=5, embed='timeF', freq='h', dropout=0.1,
                 moving_avg=25, channel_independence=1, decomp_method='moving_avg', use_norm=1,
                 down_sampling_layers=3, down_sampling_window=2, down_sampling_method='avg', **kwargs):
        ...
        self.network = TimeMixer(
            task_name=task_name, seq_len=seq_len, label_len=label_len, pred_len=pred_len, enc_in=enc_in, c_out=c_out,
            e_layers=e_layers, d_model=d_model, d_ff=d_ff, top_k=top_k, embed=embed, freq=freq, dropout=dropout,
            moving_avg=moving_avg, channel_independence=channel_independence, decomp_method=decomp_method,
            use_norm=use_norm, down_sampling_layers=down_sampling_layers, down_sampling_window=down_sampling_window,
...
if __name__=='__main__':
    ...
    model=TimeMixer(seq_len=L, enc_in=C, dec_in=C, label_len = label_len, pred_len=pred_len, c_out=1)
