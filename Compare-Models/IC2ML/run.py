...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='NCM', help='NCA, NCM, NCMNCA, NASA')
    ...
    parser.add_argument('--nasa_voltage_start', type=float, default=3.6,
                        help='NASA charge-segment start voltage')
    parser.add_argument('--nasa_voltage_end', type=float, default=3.7,
                        help='NASA charge-segment end voltage')
    ...
    if args.condition is None:
        args.condition = 'B0018' if args.dataset == 'NASA' else 'CY25-05_1'
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if args.dataset == 'NASA':
                setting += '_voltage{:.1f}-{:.1f}'.format(
                    args.nasa_voltage_start, args.nasa_voltage_end
                )
